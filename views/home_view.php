        ...
        <div class="w-full md:w-4/7">
            ...
            <div class="rounded w-full flex flex-col md:flex-row mb-10">
                ...
                <div class="bg-white rounded px-4">
                    ...
                    <p class="block md:hidden p-2 pl-0 pt-1 text-sm text-gray-600">
                        Wonder matter now can estate esteem assure fat roused. Am performed on existence as discourse
            ...
            <div class="rounded w-full flex flex-col md:flex-row mb-10">
                ...
                <div class="bg-white rounded px-4">
                    ...
                    <p class="block md:hidden p-2 pl-0 pt-1 text-sm text-gray-600">
                        Meant to learn of vexed if style allow he there. Tiled man stand tears ten joy there terms any
                        widen.
                    </p>
                </div>
            </div>
        ...
        <div class="rounded w-full lg:w-1/2 lg:w-1/3 p-4 lg:p-0">
            ...
            <div class="p-4 pl-0">
                ...
                <p class="text-gray-700 mt-2">
                    ...
                    additions.
                    So continued he or commanded household smallness delivered. Door poor on do walk in half. Roof his
                    head the what.
                </p>
